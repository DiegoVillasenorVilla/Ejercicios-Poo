...
c=parseInt(readline());
if(a==0){
print('Su nùmero a es neutro aditivo(0)');
} 
if(b==0){
print('Su nùmero b es neutro aditivo(0)');
}
if(c==0){
print('Su nùmero c es neutro aditivo(0)');
}
if(a<0){
var cua=a*a
...
var pert=a+b+c
var ecua=-b+Math.sqrt((b*b)-4*(a*c))/2*a
print('El perimetro de este triangulo es:' + pert);
print('EL resultado de la formula general es:'+ ecua); 
